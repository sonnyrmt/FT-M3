...
function problemA() {
  ...
  // promise version
  // ???
  const firstRead = promisifiedReadFile("poem-one/stanza-01.txt").then((res) =>
    blue(res)
  );
}
...
function problemB() {
  ...
  // promise version
  // ???
  const secondRead = promisifiedReadFile("poem-one/stanza-02.txt");
  const thirdRead = promisifiedReadFile("poem-one/stanza-03.txt");

  secondRead.then((res) => blue(res));
  thirdRead.then((res) => blue(res));
}
